...
`HS-Offline-Launcher` is developed as a submodule of the
...
- **This module's guide:** [`../docs/submodules/HS-Offline-Launcher/instructions.md`](../docs/submodules/HS-Offline-Launcher/instructions.md) —
  [view on GitHub](https://github.com/falorfrozen-cmd/hero-siege-offline-toolkit/blob/main/docs/submodules/HS-Offline-Launcher/instructions.md)
